...
mav = mavutil.mavlink_connection('/dev/ttyAMA0', baud=57600, source_component=191, source_system=1)
mav.wait_heartbeat()
    ...
    while True:
        ...
        while True:
            ...
            if msg.get_type() == 'RC_CHANNELS':
                current_rc_state = msg.chan7_raw >= 1200 if msg.chan7_raw is not None else False
        ...
        cv2.putText(frame, offset_text, (text_x, text_y + 30), font, font_scale, color, font_thickness, cv2.LINE_AA)
        ...
        cv2.putText(frame, text_warg, (warg_text_x, warg_text_y), font, font_scale_warg, color, 1, cv2.LINE_AA)
        ...
        cv2.putText(frame, ir_error_text, (gps_text_x, ir_error_text_y), font, font_scale_warg, color, 1, cv2.LINE_AA)
        cv2.putText(frame, gps_text, (gps_text_x, gps_text_y), font, font_scale_warg, color, 1, cv2.LINE_AA)
